...
/* harmony import */ var _includes_popups_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./includes/popups.js */ "./src/static/js/includes/popups.js");
...
(0,_includes_popups_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
// Slider ===================================================================
//First Screen
new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.first-screen__header-media-slider-body', {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_1__.Pagination],
  direction: 'horizontal',
  pagination: {
    el: '.first-screen__header-media-slider-padination',
    clickable: true
  },
  navigation: {
    nextEl: '.first-screen__header-media-slider-button-next',
    prevEl: '.first-screen__header-media-slider-button-prev'
  },
  loop: true,
  spaceBetween: 16,
  slidesPerView: 1.3,
...
//Activity Screen
new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.activity__accordion-wrapper-slider', {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_1__.Pagination],
  pagination: {
    el: '.activity__accordion-wrapper-footer-controllers-padination',
    clickable: true
  },
  navigation: {
    nextEl: '.activity__accordion-wrapper-footer-controllers-next',
    prevEl: '.activity__accordion-wrapper-footer-controllers-prev'
  },
  loop: true,
  spaceBetween: 16,
  slidesPerView: 1.3,
...
// Members Screen
let memberSliderText = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.member__slider-text', {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_1__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_1__.Controller],
  scrollbar: {
    el: '.member__slider-text-controllers-scrollbar'
  },
  navigation: {
    nextEl: '.member__slider-text-controllers-button-next',
    prevEl: '.member__slider-text-controllers-button-prev'
  },
  spaceBetween: 16,
  slidesPerView: 1,
  direction: 'horizontal',
...
let memberSliderMedia = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.member__slider-media', {
  modules: [swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_1__.Scrollbar, swiper__WEBPACK_IMPORTED_MODULE_1__.Controller],
  spaceBetween: 30,
  breakpoints: {
    360: {
...
memberSliderText.controller.control = memberSliderMedia;
memberSliderMedia.controller.control = memberSliderText;
//Spoiller ===================================================================
document.querySelectorAll('.activity__accordion-title').forEach(item => item.addEventListener('click', () => {
  const parent = item.parentNode;
  if (window.innerWidth >= 991.98) {
    if (!parent.classList.contains('active')) {
      document.querySelector('.activity__accordion-item').classList.add('active');
      document.querySelectorAll('.activity__accordion-item').forEach(child => child.classList.remove('active'));
